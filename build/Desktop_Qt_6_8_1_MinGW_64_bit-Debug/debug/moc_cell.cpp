...
static constexpr auto qt_meta_stringdata_ZN4CellE = QtMocHelpers::stringData(
    "Cell",
    "leftClicked",
    "",
    "x",
...
Q_CONSTINIT static const uint qt_meta_data_ZN4CellE[] = {
...
Q_CONSTINIT const QMetaObject Cell::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4CellE.offsetsAndSizes,
    qt_meta_data_ZN4CellE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4CellE_t,
        // Q_OBJECT / Q_GADGET
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Cell::*)(int , int );
            if (_q_method_type _q_method = &Cell::leftClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Cell::*)(int , int );
            if (_q_method_type _q_method = &Cell::rightClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Cell::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4CellE.stringdata0))
...
// SIGNAL 0
void Cell::leftClicked(int _t1, int _t2)
{
...
// SIGNAL 1
void Cell::rightClicked(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
